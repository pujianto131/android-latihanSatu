package com.blogspot.pilarislam131.latihansatu;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public  void onClick(View v){
        if (v.getId() == R.id.btn_calculate){
            String length = edtWidth.getText().toString().trim();
            String width = edtHeight.getText().toString().trim();
            ...
            if (TextUtils.isEmpty(height)){
                isEmptyFields =true;
                edtHeight.setError("Filed ini tidak boleh kosong");
            }
            if (!isEmptyFields){
